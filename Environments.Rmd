...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/bag-of-names.png", dpi = 220)
```
...
```
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/bindings.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/parents.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/search-path.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/where-ex.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/enclosing.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/binding.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/binding-2.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/namespace.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/execution.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/closure-2.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/environments.png/calling.png")
```
...
A hashmap is a data structure that takes constant, O(1), time to find an object based on its name. Environments provide this behaviour by default, so can be used to simulate a hashmap. See the CRAN package `hash` for a complete development of this idea. Or simply use the `list2env` function (from `base`). \index{hashmaps} \index{dictionaries}
